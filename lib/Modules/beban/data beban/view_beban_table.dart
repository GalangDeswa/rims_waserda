...
class MenuItem {
  const MenuItem({required this.text, required this.icon, this.iconcolor});
...
abstract class MenuItems {
  ...
  static const edit =
      MenuItem(text: 'Edit beban', icon: Icons.edit, iconcolor: false);
  static const hapus =
      MenuItem(text: 'Hapus beban', icon: Icons.delete, iconcolor: true);
  ...
  static void onChanged(BuildContext context, MenuItem item, DataBeban data) {
    var con = Get.find<bebanController>();
    switch (item) {
      case MenuItems.edit:
        print('edit');
        Get.toNamed('/edit_beban', arguments: data);
        break;
      case MenuItems.hapus:
        popscreen().deletebebanv2(con, data);
        break;
    }
  }
}
